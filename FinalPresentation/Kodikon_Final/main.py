...
def fundapoints():
    ...
    openai.api_key = "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"
    ...
    total_assets = int(ls[0])
    net_income = int(ls[1])
    total_debt = int(ls[2])
    eps = ls[3]
    liabilities = int(ls[4])
    free_cash_flow = int(ls[5])
    equity = int(ls[6])
...
def ask(question):
    ...
    loader = PyPDFLoader('Meta-12.31.2022-Exhibit-99.1-FINAL.pdf')
    pdf_text = loader.load_and_split()[0:6]
